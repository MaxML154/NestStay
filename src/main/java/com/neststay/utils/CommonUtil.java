...
public class CommonUtil {
  ...
  public static String getCellValue(Cell cell) {
    ...
    switch (cellType) {
      ...
      case STRING:
        resultValue =
            StringUtils.isEmpty(cell.getStringCellValue()) ? "" : cell.getStringCellValue().trim();
        break;
        // 布尔类型
      case BOOLEAN:
      ...
      case NUMERIC:
        /**
         * format 的值可能为以下这些 yyyyMMddHHmmss yyyy-MM-dd----- 14 yyyy年m月d日----- 31 yyyy年m月--------57
         * m月d日 -----------58 HH:mm-----------20 h时mm分 --------- 32
         */
  ...
  public static void cmd(String cmd) {
    ...
    try {
      ...
      if (osName.contains("Windows")) {
        // Windows下
        String[] content = {"cmd", "/c", cmd};
        command = content;
      } else {
        // linux下
        String[] content = {"/bin/sh", "-c", cmd};
        command = content;
      }
